      ...
      <div className="max-w-[970px] max-h-[850px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l lg:pl-16 py-5">
            <h3 className=" text-HeadingColor font-semibold text-[22px] pb-5 ">
              Create an <span className="text-Color">Account</span>
            </h3>
            <form action="" onSubmit={submitHandler}>
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <label
                  htmlFor=""
                  className="text-TextColor font-bold text-[15px] leading-7 px-4"
                >
                  Gender
                  <select
                    name="gender"
              ...
              <p className="text-center paragraph">
                ...
                <Link to="/login" className="font-semibold text-TextColor">
                  Login here
                </Link>
              </p>
            </form>
